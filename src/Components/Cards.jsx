...
const Cards = ({id, name, src, type, price }) => {
        ...
        <>
            <div className='cardContainer' id={id}>
                <div className='cardDetails'>
                    ...
                    <button style={{ color: "yellowgreen", padding: "1vh 3vh", position: "absolute", bottom: "1%", marginLeft: "1vh", border: "1px solid yellowgreen", fontSize: "3vh", cursor: "pointer" }}>Add to Cart</button>
                </div>
